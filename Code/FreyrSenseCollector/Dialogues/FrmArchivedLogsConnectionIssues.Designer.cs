namespace FreyrSenseCollector.Dialogues
{
    partial class FrmArchivedLogsConnectionIssues
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblMessage.Text = "We could not access your Qlik Sense archived folders.\r\nThe installation reported " +
    "the path: \'{0}\' \r\n\r\nYou can supply the path or collect the logs manually and att" +
    "ach them also to the case.";
            // 
            // cmdTry
            // 
            ...
            this.label1.Text = "New Qlik Sense archived logs path:";
            // 
            ...
            this.Text = "Archived folders not found!";
