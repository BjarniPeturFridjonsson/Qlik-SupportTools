namespace FreyrQvLogCollector.Dialogues
{
    partial class FrmConnectionIssues
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblMessage.Size = new System.Drawing.Size(480, 38);
            this.lblMessage.TabIndex = 34;
            this.lblMessage.Text = "We could not connect to QlikView on this machine using the credentials that this " +
    "program is running as.";
            ...
            this.cmdConnectToRemoteHost.Text = "QlikView is located elsewhere\r\n ";
            ...
            this.cmdRunOnlyLocalLogs.Text = "QlikView is not running or accessible        ";
            ...
            this.cmdShowConnectionHowTo.Text = "QlikView is running and on this host?\r\n\r\n";
            ...
            this.Text = "QlikView Log Reader - Can\'t connect to QlikView";
