...
namespace FreyrQvLogCollector
{
    public partial class FrmMain : Form
    {
        ...
        private readonly ILogger _logger = new Logger("Qlik View Log Collector");
        ...
        private void txtCaseNr_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            new FrmResult(_runner.CollectorService,_logger).ShowDialogueCenterParent(this);
        }
